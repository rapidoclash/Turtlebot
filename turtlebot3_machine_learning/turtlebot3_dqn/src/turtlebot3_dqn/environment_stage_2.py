...
class Env():
    ...
    def setReward(self, state, done, action):
        ...
        distance_reward = (previous_distance - current_distance) * 500  # Récompense basée sur l'amélioration de la distance
        self.previous_distance = current_distance

        reward += distance_reward

        # Récompenses pour la direction
        direction_reward = (1 - abs(heading)) * 100  # Récompense basée sur la direction
